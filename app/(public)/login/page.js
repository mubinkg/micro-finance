            ...
            <div style={{
                ...
                <div style={{ width: "360px", display: "flex", flexDirection: "column", justifyContent: "center", alignContent: "center", }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", marginTop: "10px" }}>
                        <p style={{ cursor: "pointer", color: "blue" }} onClick={() => router.push('/forget-password')}>Forgot password?</p>
                        <p style={{ cursor: "pointer", marginLeft: "10px", color: "blue" }} onClick={() => router.push('/registration')}>Sign Up</p>
                    </div>
                </div>
            </div>
        </div>
